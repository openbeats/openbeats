            ...
            <div className="main-search-wrapper">
                <div className="main-search">
                    <form action="" onSubmit={async (e) => { e.preventDefault(); await this.props.fetchResults(this.state.suggestionText); }}>
                        <input type="text" value={this.state.suggestionText} onChange={async (e) => { this.setState({ suggestionText: e.target.value }); await this.props.getKeywordSuggestion(e) }} className="search-input" placeholder="Search Your Music Here!" />
